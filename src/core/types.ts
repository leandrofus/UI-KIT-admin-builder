...
export type FieldValue = PrimitiveValue | Date | PrimitiveValue[] | Record<string, unknown>;
...
export type FieldType =
  ...
  | 'color'
  | 'range'
  | 'entity'      // Selector de entidades externas (e.g., categories, suppliers)
  | 'generic'     // Campo custom con componente personalizado
  | 'hidden';
 ...
 */
export interface ColumnAction<T = DataRecord> {
  /** Action identifier */
  id: string;
  /** Display label */
  label: string;
 ...
 */
export interface SelectionConfig<T = DataRecord> {
  /** Selection mode */
 ...
 */
export interface TableConfig<T = DataRecord> {
  /** Table identifier */
  id?: string;
 ...
 */
export interface ServerTableQueryParams extends PaginationParams {
 ...
 */
export interface TableEventHandlers<T = DataRecord> {
 ...
 * Form event handlers
 */
export interface FormEventHandlers<T = DataRecord> {
...
// React type import for render functions
