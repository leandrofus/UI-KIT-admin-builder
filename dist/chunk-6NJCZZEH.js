      ...
      children: [
        showSearch && /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "dui-table-toolbar-search", children: [
          ...
          /* @__PURE__ */ jsxRuntime.jsx(
            "input",
            {
              ...
              placeholder: searchPlaceholder || chunkFNVTC5WT_js.t("table.search", { default: "Buscar..." }),
              disabled,
        ...
        showAdvancedSearch && onAdvancedSearch && /* @__PURE__ */ jsxRuntime.jsxs(
          "button",
          {
            ...
            title: chunkFNVTC5WT_js.t("table.advancedSearch", { default: "B\xFAsqueda avanzada" }),
            children: [
              Icons.advancedSearch,
              chunkFNVTC5WT_js.t("table.advancedSearch", { default: "Avanzada" })
            ]
          }
        ),
        showViewSwitcher && onViewChange && /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "dui-table-view-switcher", style: { display: "flex", background: "var(--bg-tertiary)", padding: "2px", borderRadius: "8px", marginLeft: "0.5rem" }, children: [
          /* @__PURE__ */ jsxRuntime.jsx(
            "button",
            {
              ...
              title: chunkFNVTC5WT_js.t("table.viewTable", { default: "Vista Tabla" }),
          ...
          /* @__PURE__ */ jsxRuntime.jsx(
            "button",
            {
              ...
              style: { borderRadius: "6px", minWidth: "40px", display: "flex", alignItems: "center", justifyContent: "center" },
              title: chunkFNVTC5WT_js.t("table.viewKanban", { default: "Vista Kanban" }),
        ...
        /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "dui-table-toolbar-actions", style: { display: "flex", alignItems: "center", gap: "0.5rem" }, children: [
          selectedCount > 0 ? /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
            /* @__PURE__ */ jsxRuntime.jsx("span", { className: "dui-table-toolbar-selection-badge", style: { marginRight: "0.5rem" }, children: chunkFNVTC5WT_js.t("table.selected", { count: selectedCount }) }),
            onDeleteSelected && /* @__PURE__ */ jsxRuntime.jsxs(
              "button",
              {
                ...
                children: [
                  Icons.trash,
                  deleteLabel || chunkFNVTC5WT_js.t("table.delete")
                ]
              }
            ),
            onToggleEnabled && /* @__PURE__ */ jsxRuntime.jsx(
              "button",
              {
                ...
                disabled,
                className: "dui-table-toolbar-btn dui-table-toolbar-btn-secondary",
                title: chunkFNVTC5WT_js.t("table.toggleEnabled", { default: "Habilitar/Deshabilitar" }),
            ...
            onClearSelection && /* @__PURE__ */ jsxRuntime.jsx(
              "button",
              {
                ...
                disabled,
                className: "dui-table-toolbar-btn dui-table-toolbar-btn-secondary",
                children: chunkFNVTC5WT_js.t("table.clearSelection")
              }
            ),
            ...
            /* @__PURE__ */ jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [
              showRefresh && onRefresh && /* @__PURE__ */ jsxRuntime.jsxs(
                "button",
                {
                  ...
                  className: "dui-table-toolbar-btn dui-table-toolbar-btn-secondary",
                  title: chunkFNVTC5WT_js.t("table.refresh", { default: "Refrescar" }),
                  children: [
                    Icons.refresh,
                    chunkFNVTC5WT_js.t("table.refresh", { default: "Refrescar" })
                  ]
                }
              ),
              showCreate && onCreate && /* @__PURE__ */ jsxRuntime.jsxs(
                "button",
                {
                  ...
                  children: [
                    Icons.plus,
                    createLabel || chunkFNVTC5WT_js.t("table.create", { default: "Crear" })
                  ]
                }
              )
            ] })
          ...
          props.showExport && onExport && /* @__PURE__ */ jsxRuntime.jsxs(
            "button",
            {
              ...
              disabled,
              className: "dui-table-toolbar-btn dui-table-toolbar-btn-secondary",
              title: chunkFNVTC5WT_js.t("export", { default: "Exportar" }),
              children: [
                ...
                selectedCount > 0 ? "" : chunkFNVTC5WT_js.t("export", { default: "Exportar" })
              ]
            }
          ),
          props.showColumnsButton && onOpenColumns && /* @__PURE__ */ jsxRuntime.jsxs(
            "button",
            {
              ...
              disabled,
              className: "dui-table-toolbar-btn dui-table-toolbar-btn-secondary",
              title: chunkFNVTC5WT_js.t("columns.title", { default: "Columnas" }),
              children: [
                chunkFNVTC5WT_js.t("columns.title", { default: "Columnas" }),
...
function DefaultEmptyState() {
  const { t: t6 } = chunkFNVTC5WT_js.useI18n();
    ...
    case "status": {
      ...
      if (Array.isArray(value)) {
        return /* @__PURE__ */ jsxRuntime.jsx("div", { style: { display: "flex", flexWrap: "wrap", gap: "4px", alignItems: "center" }, children: value.map((item, i) => {
          const display = item && typeof item === "object" ? item.label ?? item.name ?? String(item) : chunkFNVTC5WT_js.resolveLabel(String(item), void 0, namespace);
      ...
      if (variants && variants.length > 0) {
        ...
        if (variant) {
          const display = chunkFNVTC5WT_js.resolveLabel(variant.label || variant.name || String(variant.value), void 0, namespace);
      ...
      if (value && typeof value === "object") {
        ...
        return /* @__PURE__ */ jsxRuntime.jsx(
          "span",
          {
            ...
            children: chunkFNVTC5WT_js.resolveLabel(String(display), void 0, namespace)
          }
        );
      }
      return /* @__PURE__ */ jsxRuntime.jsx("span", { className: chunkG4EIC5OB_js.cn("dui-table-badge", `dui-table-badge-${String(value).toLowerCase()}`), children: chunkFNVTC5WT_js.resolveLabel(String(value), void 0, namespace) });
    }
    case "link":
      return /* @__PURE__ */ jsxRuntime.jsx(
        "a",
              ...
              children: [
                /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "dui-table-th-content", children: [
                  /* @__PURE__ */ jsxRuntime.jsx("span", { className: "dui-table-th-text", children: (function getColumnLabel() {
                    ...
                    return chunkFNVTC5WT_js.resolveLabel(headerStr || String(column.key), void 0, namespace);
                  })() }),
                      ...
                      "td",
                      {
                        ...
                        children: /* @__PURE__ */ jsxRuntime.jsx("div", { style: {
                          ...
                          return /* @__PURE__ */ jsxRuntime.jsx(
                            ...
                            {
                              type: "button",
                              title: typeof action.label === "string" ? chunkFNVTC5WT_js.resolveLabel(action.label) : void 0,
                              className: `btn btn-sm ${getVariantClass(action.variant)}`,
                              onClick: (e) => {
                                e.stopPropagation();
                                action.onClick?.(row, rowIndex);
                              },
                              children: renderedIcon ? renderedIcon : typeof action.label === "string" ? chunkFNVTC5WT_js.resolveLabel(action.label) : action.label
                            },
                            action.id
                          );
                        }) })
      ...
      return /* @__PURE__ */ jsxRuntime.jsxs(
        "button",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntime.jsx("span", { children: chunkFNVTC5WT_js.resolveLabel(tab.label) })
          ]
        },
        tab.id
      );
  ...
  if (field.type === "select" || field.type === "multiselect") {
    return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: chunkG4EIC5OB_js.cn("dui-field", hasError && "dui-field--error"), children: [
      /* @__PURE__ */ jsxRuntime.jsxs("label", { htmlFor: inputId, className: "dui-field__label", children: [
        chunkFNVTC5WT_js.resolveLabel(String(field.label)),
      ...
      /* @__PURE__ */ jsxRuntime.jsxs(
        "select",
        {
          ...
          children: [
            !field.required && /* @__PURE__ */ jsxRuntime.jsx("option", { value: "", children: chunkFNVTC5WT_js.resolveLabel("select_placeholder", "Select...") }),
            field.options?.map((option) => /* @__PURE__ */ jsxRuntime.jsx(
              "option",
              {
                value: String(option.value),
                disabled: option.disabled,
                children: chunkFNVTC5WT_js.resolveLabel(String(option.label))
              },
              String(option.value)
            ))
          ]
  ...
  if (field.type === "checkbox" || field.type === "switch") {
    return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: chunkG4EIC5OB_js.cn("dui-field dui-field--checkbox", hasError && "dui-field--error"), children: [
      /* @__PURE__ */ jsxRuntime.jsxs("label", { className: "dui-field__checkbox-label", children: [
        ...
        /* @__PURE__ */ jsxRuntime.jsx("span", { children: chunkFNVTC5WT_js.resolveLabel(String(field.label)) }),
        field.required && /* @__PURE__ */ jsxRuntime.jsx("span", { className: "dui-field__required", children: "*" })
      ] }),
      field.helpText && /* @__PURE__ */ jsxRuntime.jsx("p", { className: "dui-field__help", children: chunkFNVTC5WT_js.resolveLabel(String(field.helpText)) }),
      hasError && /* @__PURE__ */ jsxRuntime.jsx("p", { className: "dui-field__error", children: error })
    ] });
  }
    ...
    return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: chunkG4EIC5OB_js.cn("dui-field", hasError && "dui-field--error"), children: [
      ...
      /* @__PURE__ */ jsxRuntime.jsx(
        "textarea",
        {
          ...
          placeholder: field.placeholder ? chunkFNVTC5WT_js.resolveLabel(String(field.placeholder)) : void 0,
  ...
  if (field.type === "radio") {
    return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: chunkG4EIC5OB_js.cn("dui-field", hasError && "dui-field--error"), children: [
      ...
      /* @__PURE__ */ jsxRuntime.jsx("div", { className: chunkG4EIC5OB_js.cn(
        ...
        /* @__PURE__ */ jsxRuntime.jsx("span", { children: chunkFNVTC5WT_js.resolveLabel(String(option.label)) })
      ] }, String(option.value))) }),
      field.helpText && /* @__PURE__ */ jsxRuntime.jsx("p", { className: "dui-field__help", children: chunkFNVTC5WT_js.resolveLabel(String(field.helpText)) }),
      hasError && /* @__PURE__ */ jsxRuntime.jsx("p", { className: "dui-field__error", children: error })
    ] });
      ...
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntime.jsxs("div", { className: "dui-form-section__title-group", children: [
            /* @__PURE__ */ jsxRuntime.jsx("h3", { className: "dui-form-section__title", children: typeof section.title === "string" ? chunkFNVTC5WT_js.resolveLabel(section.title) : section.title }),
            section.description && /* @__PURE__ */ jsxRuntime.jsx("p", { className: "dui-form-section__description", children: typeof section.description === "string" ? chunkFNVTC5WT_js.resolveLabel(section.description) : section.description })
          ] }),
...
var SidebarRenderer = ({
  ...
  const translate = passedT || chunkFNVTC5WT_js.t;
  const isActive = (path) => {
...
//# sourceMappingURL=chunk-6NJCZZEH.js.map
//# sourceMappingURL=chunk-6NJCZZEH.js.map