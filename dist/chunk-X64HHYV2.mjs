...
import { useI18n, resolveLabel } from './chunk-R3OGNEXV.mjs';
...
var TextareaField = forwardRef(
  function TextareaField2(props, ref) {
    ...
    return /* @__PURE__ */ jsxs("div", { className: cn("field-wrapper", className), children: [
      ...
      hasError && /* @__PURE__ */ jsx("p", { className: errorTextClass, children: error }),
      field.helpText && !hasError && /* @__PURE__ */ jsx("p", { className: helperTextClass, children: t(String(field.helpText)) })
    ] });
  }
);
  ...
  function SwitchField2(props, ref) {
    ...
    return /* @__PURE__ */ jsxs("div", { className: cn("field-wrapper", className), children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-3", children: [
        offLabel && /* @__PURE__ */ jsx("span", { className: "text-sm text-gray-600", children: resolveLabel(String(offLabel)) }),
        /* @__PURE__ */ jsx(
          "button",
          {
            ref,
        ...
        onLabel && /* @__PURE__ */ jsx("span", { className: "text-sm text-gray-600", children: t(String(onLabel)) })
      ] }),
      hasError && /* @__PURE__ */ jsx("p", { className: errorTextClass, children: error }),
      field.helpText && !hasError && /* @__PURE__ */ jsx("p", { className: helperTextClass, children: field.helpText })
    ] });
...
//# sourceMappingURL=chunk-X64HHYV2.mjs.map
//# sourceMappingURL=chunk-X64HHYV2.mjs.map