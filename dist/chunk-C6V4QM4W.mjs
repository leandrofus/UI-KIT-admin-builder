import { cn, evaluateConditions, getNestedValue, validateField } from './chunk-MWNP5OJS.mjs';
import { useI18n, resolveLabel, t } from './chunk-R3OGNEXV.mjs';
import React3, { forwardRef, useState, useMemo, useCallback, useEffect, useImperativeHandle, useRef } from 'react';
...
function TableToolbar(props) {
  ...
  return /* @__PURE__ */ jsx(
    "div",
    {
      ...
      children: selectedCount > 0 ? /* @__PURE__ */ jsxs("div", { style: { display: "flex", alignItems: "center", gap: "1rem" }, children: [
        /* @__PURE__ */ jsx("span", { className: "dui-table-toolbar-selection-badge", children: t2("table.selected", { count: selectedCount }) }),
        ...
        (showRefresh || showCreate || showAdvancedSearch || showSearch) && /* @__PURE__ */ jsx("div", { className: "dui-table-toolbar-spacer" }),
...
function DefaultEmptyState() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "dui-table-empty", children: [
    ...
    /* @__PURE__ */ jsx("p", { className: "dui-table-empty-text", children: t2("table.empty") })
  ] });
}
function DefaultLoadingState() {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "dui-table-loading", children: [
    ...
    /* @__PURE__ */ jsx("p", { className: "dui-table-loading-text", children: t2("table.loading") })
  ] });
}
function DefaultErrorState({ error }) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "dui-table-error", children: [
    ...
    /* @__PURE__ */ jsx("p", { className: "dui-table-error-text", children: t2("table.error") }),
...
function formatCellValue(value, column, row, emptyValuePlaceholder) {
  ...
  switch (column.type) {
    ...
    case "badge":
    case "status":
      return /* @__PURE__ */ jsx("span", { className: cn("dui-table-badge", `dui-table-badge-${String(value).toLowerCase()}`), children: String(value) });
    case "link":
      return /* @__PURE__ */ jsx(
        "a",
        {
...
function Pagination({
  ...
  return /* @__PURE__ */ jsxs("div", { className: "dui-table-pagination", children: [
    /* @__PURE__ */ jsx("div", { className: "dui-table-pagination-info", children: t2(
  ...
  return /* @__PURE__ */ jsxs("div", { className: cn("dui-table-container", effectiveTheme === "dark" ? "dui-theme--dark" : "dui-theme--light", className), style: containerStyle, children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "dui-table-wrapper", style: preventLayoutShift ? { scrollbarGutter: "stable" } : {}, children: /* @__PURE__ */ jsxs("table", { className: tableClasses, children: [
      /* @__PURE__ */ jsx("thead", { className: "dui-table-head", children: renderHeader ? renderHeader(visibleColumns) : /* @__PURE__ */ jsxs("tr", { className: "dui-table-row dui-table-header-row", children: [
        selectable && selectionMode === "multiple" && /* @__PURE__ */ jsx("th", { className: "dui-table-th dui-table-th-checkbox", children: /* @__PURE__ */ jsx(
          Checkbox,
          {
        ...
        selectable && selectionMode === "single" && /* @__PURE__ */ jsx("th", { className: "dui-table-th dui-table-th-radio" }),
        showRowNumbers && /* @__PURE__ */ jsx("th", { className: "dui-table-th dui-table-th-rownum", children: "#" }),
        visibleColumns.map((column) => /* @__PURE__ */ jsx(
          "th",
          {
            ...
            children: /* @__PURE__ */ jsxs("div", { className: "dui-table-th-content", children: [
              /* @__PURE__ */ jsx("span", { className: "dui-table-th-text", children: typeof column.header === "string" ? resolveLabel(column.header) : column.header }),
        ...
        renderActions && /* @__PURE__ */ jsx("th", { className: "dui-table-th dui-table-th-actions", children: t2("table.actions") })
      ] }) }),
        ...
        return /* @__PURE__ */ jsxs(
          "tr",
          {
            ...
            children: [
              ...
              showRowNumbers && /* @__PURE__ */ jsx("td", { className: "dui-table-td dui-table-td-rownum", children: rowIndex + 1 }),
...
function DefaultFieldRenderer({
  ...
  if (field.type === "radio") {
    return /* @__PURE__ */ jsxs("div", { className: cn("dui-field", hasError && "dui-field--error"), children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "dui-field__radio-group", children: field.options?.map((option) => /* @__PURE__ */ jsxs("label", { className: "dui-field__radio-label", children: [
        /* @__PURE__ */ jsx(
          "input",
          {
            type: "radio",
...
function FormRendererInner(props, ref) {
  ...
  const initialValuesRef = React3.useRef(initialValues);
  ...
  const renderSectionElement = useCallback((section) => {
    ...
    if (customRenderSection) {
      return /* @__PURE__ */ jsx(React3.Fragment, { children: customRenderSection(sectionProps) }, section.id);
    }
...
function ConfirmDialog({ open, onConfirm, onCancel, config, loading }) {
  ...
  return /* @__PURE__ */ jsx("div", { className: "dui-modal__confirm-overlay", children: /* @__PURE__ */ jsxs("div", { className: "dui-modal__confirm-dialog", children: [
    /* @__PURE__ */ jsx("h4", { className: "dui-modal__confirm-title", children: typeof config.title === "string" ? t2(config.title) : config.title }),
    /* @__PURE__ */ jsx("p", { className: "dui-modal__confirm-message", children: typeof config.message === "string" ? t2(config.message) : config.message }),
...
export { DynamicModal, FormRenderer, TableRenderer, TableToolbar };
//# sourceMappingURL=chunk-C6V4QM4W.mjs.map
//# sourceMappingURL=chunk-C6V4QM4W.mjs.map