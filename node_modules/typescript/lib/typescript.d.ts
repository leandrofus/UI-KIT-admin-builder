...
declare namespace ts {
    namespace server {
        namespace protocol {
            ...
            export interface ProjectInfo {
                /**
                 * For configured projecthis is the normalized path of the 'tsconfig.json' file
                 * For inferred projecthis is undefined
                 */
            ...
            export interface GetPasteEditsRequestArgs extends FileRequestArgs {
                ...
                /** The source location of each `pastedText`. If presenthe length of `spans` must be equal to the length of `pastedText`. */
                copiedFrom?: {
                    file: string;
                    spans: TextSpan[];
                };
            ...
            export interface ConfigureRequestArguments {
                ...
                hostInfo?: string;
                /**
                 * If presentab settings apply only to this file.
                 */
                file?: string;
                /**
        ...
        interface ITypingsInstaller {
            ...
            enqueueInstallTypingsRequest(p: ProjectypeAcquisition: TypeAcquisition, unresolvedImports: SortedReadonlyArray<string> | undefined): void;
            attach(projectService: ProjectService): void;
            onProjectClosed(p: Project): void;
            readonly globalTypingsCacheLocation: string | undefined;
        }
        function createInstallTypingsRequest(project: ProjectypeAcquisition: TypeAcquisition, unresolvedImports: SortedReadonlyArray<string>, cachePath?: string): DiscoverTypings;
     ...
     * Unless `isExportEquals` is sethis node was parsed as an `export default`.
     */
    ...
    interface NodeFactory {
        ...
        updateTryStatement(node: TryStatementryBlock: Block, catchClause: CatchClause | undefined, finallyBlock: Block | undefined): TryStatement;
        ...
        updateJSDocText(node: JSDocTextext: string): JSDocText;
        ...
        updateJsxSelfClosingElement(node: JsxSelfClosingElementagName: JsxTagNameExpression, typeArguments: readonly TypeNode[] | undefined, attributes: JsxAttributes): JsxSelfClosingElement;
        ...
        updateJsxOpeningElement(node: JsxOpeningElementagName: JsxTagNameExpression, typeArguments: readonly TypeNode[] | undefined, attributes: JsxAttributes): JsxOpeningElement;
        createJsxClosingElement(tagName: JsxTagNameExpression): JsxClosingElement;
        updateJsxClosingElement(node: JsxClosingElementagName: JsxTagNameExpression): JsxClosingElement;
        ...
        updateJsxText(node: JsxTextext: string, containsOnlyTriviaWhiteSpaces?: boolean): JsxText;
    ...
    function createScanner(languageVersion: ScriptTarget, skipTrivia: boolean, languageVariant?: LanguageVariantextInitial?: string, onError?: ErrorCallback, start?: number, length?: number): Scanner;
    ...
    interface CreateSourceFileOptions {
         ...
         * `getSetExternalModuleIndicator` on a valid `CompilerOptions` object. If not presenthe default
     ...
     * @param compilerOptions The compiler options for the program that owns the file. If the file belongs to a referenced projecthe compiler options
     ...
     * Depending on the character and the syntactic contexthe request may or may not be served a result.
     */
    ...
    interface CompletionEntry {
         ...
         * If presenthis span should be used instead of the default one.
