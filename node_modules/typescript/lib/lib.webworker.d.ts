...
interface BroadcastChannel extends EventTarget {
    ...
    close(): void;
    /**
     * The **`postMessage()`** method of the BroadcastChannel interface sends a message, which can be of any kind of Objecto each listener in any browsing context with the same origin.
     *
...
interface FontFace {
    /**
     * The **`ascentOverride`** property of the FontFace interface returns and sets the ascent metric for the fonthe height above the baseline that CSS uses to lay out line boxes in an inline formatting context.
     *
...
interface IDBRequest<T = any> extends EventTarget {
    ...
    /**
     * The **`transaction`** read-only property of the IDBRequest interface returns the transaction for the requesthat is, the transaction the request is being made inside.
     *
...
interface WebGL2RenderingContextBase {
    ...
    vertexAttribIPointer(index: GLuint, size: GLintype: GLenum, stride: GLsizei, offset: GLintptr): void;
...
interface WebGLRenderingContextBase {
    ...
    vertexAttribPointer(index: GLuint, size: GLintype: GLenum, normalized: GLboolean, stride: GLsizei, offset: GLintptr): void;
