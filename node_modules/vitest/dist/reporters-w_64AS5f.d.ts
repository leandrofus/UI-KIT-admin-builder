...
type WorkspaceSpec = [project: WorkspaceProjectestFile: string];
...
interface DepsOptions {
    ...
    web?: {
         ...
         *
         * **At the momenthis option only works with `{ pool: 'vmThreads' }`.**
         *
         * @default true
         */
